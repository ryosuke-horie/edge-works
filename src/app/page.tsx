...
export default function Home() {
	return (
		<div className="min-h-screen bg-linear-to-b from-blue-50 to-white dark:from-gray-900 dark:to-gray-800">
				...
				<div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4">
					<div className="mb-8">
						<div className="flex items-center justify-center mb-2">
							<p className="text-xl sm:text-2xl lg:text-3xl text-white/90 font-medium mr-3">
								月額
							</p>
							<div className="flex items-center">
								<p className="text-4xl sm:text-6xl lg:text-8xl font-extrabold text-blue-300 tracking-tight leading-none">
									3,000
								</p>
								<span className="text-2xl sm:text-3xl lg:text-4xl text-blue-300 font-bold ml-1">
									円
								</span>
							</div>
							<p className="text-xl sm:text-2xl lg:text-3xl text-white/90 font-medium ml-3">
								で
							</p>
						</div>

						<h1 className="text-3xl sm:text-4xl lg:text-6xl font-extrabold text-white tracking-tight leading-tight">
							<span className="inline-block">ホームページを</span>
							<span className="text-blue-300 text-4xl sm:text-5xl lg:text-7xl ml-2 sm:ml-4">
								制作
							</span>
						</h1>
					</div>

					<p className="text-lg sm:text-xl lg:text-2xl text-white/80 font-medium mb-8 max-w-2xl">
						テンプレートではない、
						<span className="text-blue-300 font-semibold">あなただけ</span>
						のオリジナルデザイン
					</p>
			...
			<main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				>
					<div className="text-center p-6 rounded-xl bg-white dark:bg-gray-800 shadow-lg">
						...
						<h3 className="text-xl font-semibold mb-2">初期費用0円</h3>
					...
					<div className="text-center p-6 rounded-xl bg-white dark:bg-gray-800 shadow-lg">
						<div className="text-3xl mb-4">🎨</div>
						<h3 className="text-xl font-semibold mb-2">オリジナルデザイン</h3>
						<p className="text-gray-600 dark:text-gray-300">
					...
					<div className="text-center p-6 rounded-xl bg-white dark:bg-gray-800 shadow-lg">
						<div className="text-3xl mb-4">📱</div>
						<h3 className="text-xl font-semibold mb-2">モバイルファースト</h3>
						<p className="text-gray-600 dark:text-gray-300">
							スマートフォンでの表示を最適化
						</p>
					</div>
				...
				<div id="flow" className="py-16 bg-gray-50 dark:bg-gray-900 rounded-xl">
						...
						<div className="space-y-12 max-w-2xl mx-auto">
							...
							<div className="flex flex-col md:flex-row items-start md:items-center gap-6">
								...
								<div className="grow text-center md:text-left">
									...
									<ul className="list-disc list-inside text-gray-600 dark:text-gray-300 space-y-2">
										<li>仮のドメイン（テスト用URL）でサイトを確認可能</li>
									</ul>
								</div>
							</div>
				...
				<div id="pricing" className="py-16 text-center">
					<h2 className="text-3xl font-bold mb-12">シンプルな料金プラン</h2>
				...
				{/* FAQ Section */}
				<div id="faq" className="py-16 bg-gray-50 dark:bg-gray-900 rounded-xl">
					<div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
			...
			{/* Contact Section */}
			<div id="contact" className="py-16 bg-gray-100 dark:bg-gray-800">
			...
			<footer className="bg-gray-50 dark:bg-gray-900 py-12">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
					<div className="text-2xl font-bold mb-4">Edge works</div>
